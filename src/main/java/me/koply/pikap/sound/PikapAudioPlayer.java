 ...
 */
@Slf4j
public class PikapAudioPlayer implements AudioPlayer, TrackStateListener {
    ...
    private final PikapAudioPlayerManager manager;
     ...
     */
    public PikapAudioPlayer(PikapAudioPlayerManager manager) {
